...
includeInMenu: true
description: >-
  Starting January 2027, new gas water heaters will be banned in the Bay Area. Learn what this means for Sonoma and Marin County homeowners, replacement costs, exemptions, and why acting before the deadline could save you thousands.
...
- What you can do about it:
  ...
  <div class="two-column">
    ...
    The Bay Area Air Quality Management District adopted amendments to **[Regulation 9, Rule 4](https://www.baaqmd.gov/rules-and-compliance/rules/reg-9-rule-4-nitrogen-oxides-from-fan-type-residential-central-furnaces)** (furnaces) and **[Rule 9-6](https://www.baaqmd.gov/rules-and-compliance/rules/reg-9-rule-6-nitrogen-oxides-emissions-from-natural-gasfired-water-heaters)** (water heaters) in March 2023. These rules set emission standards for residential furnaces and water heaters.
    ...
    The rule applies to appliances **manufactured after** these dates.
  ...
  <div class="one-column">
    ...
    As of July 2025, [TECH Clean California](https://techcleanca.com/incentives/single-family-incentives/) offers heat pump water heater incentives:
    - **Market rate:** $1,100–$4,300 per unit
    - **Equity rate (income-qualified):** $3,500–$5,700 per unit (check eligibility at [tech-incomeportal.com](https://tech-incomeportal.com/))

    These incentives are available through participating contractors and can be stacked with other programs.

    ### Federal Tax Credits (Inflation Reduction Act)
    - **30% tax credit** on heat pump water heaters, up to $2,000 per year
    - Must meet [ENERGY STAR standards](https://www.energystar.gov/products/water_heaters/high_efficiency_electric_storage_water_heaters_and_heat_pump_water_heaters)
    - Use the [IRA Savings Calculator](https://homes.rewiringamerica.org/calculator) to estimate your household's eligibility

    ### Low-to-Moderate Income Rebates
    The IRA's electrification rebates cover **50–100% of costs** up to $1,750 for qualifying households.
    ...
    - [Sonoma Clean Power](https://sonomacleanpower.org/programs) — Additional incentives for SCP customers
    - [MCE (Marin Clean Energy)](https://www.mcecleanenergy.org/residential-rebates/) — Rebates for Marin County residents
